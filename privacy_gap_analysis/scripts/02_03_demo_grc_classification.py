...
def demo_ccpa_framework_classification():
    ...
    if not framework_path.exists():
        print(f"\n  CCPA framework not found at: {framework_path}")
        return
...
def run_full_demo():
    ...
    input("\n⏸  Press Enter to see GRC data types matrix...")
    print_classification_matrix()

    input("\n⏸  Press Enter to see AI deployment decision matrix...")
    print_ai_deployment_matrix()

    input("\n⏸  Press Enter for Demo 1: CCPA Framework Classification...")
    demo_ccpa_framework_classification()

    input("\n⏸  Press Enter for Demo 2: Privacy Policy Classification...")
    demo_privacy_policy_classification()

    input("\n⏸  Press Enter for Demo 3: Sensitive Data Classification...")
    demo_sensitive_data_classification()

    input("\n⏸  Press Enter to see Production Deployment Options...")
    demo_production_options()

    input("\n⏸  Press Enter to see Current Implementation...")
